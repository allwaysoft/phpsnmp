...
error_reporting(0);
	...
	{
		public function __construct($host_address,$community)
		{
		...
		private function create_data_array()
		{
			...
			if(snmpget($this->host_address, $this->community, '.iso.org.dod.internet.mgmt.mib-2.system.sysDescr.0', 300) != FALSE)
			{
				$this->data_fetched = 'yes';
				$data = snmpget($this->host_address, $this->community, '.iso.org.dod.internet.mgmt.mib-2.system.sysDescr.0', 300);
				if(strlen($data) == 0)
				{
				...
				else
				{
					...
					else
					{
						...
						elseif(substr_count($data_lower, 'aix') > 0)
						{
						    $this->operating_system = 'linux';
						}
						else
			...
			if(snmpget($this->host_address, $this->community, '.iso.org.dod.internet.mgmt.mib-2.system.sysUpTime.sysUpTimeInstance', 300) != FALSE)
			{
				$this->data_fetched = 'yes';
				$data = snmpget($this->host_address, $this->community, '.iso.org.dod.internet.mgmt.mib-2.system.sysUpTime.sysUpTimeInstance', 300);
				if(strlen($data) == 0)
				{
					$data = '<span id="no_data_received">No data received</span>';
				}
			...
			if(snmpget($this->host_address, $this->community, '.iso.org.dod.internet.mgmt.mib-2.system.sysContact.0', 300) != FALSE)
			{
				$this->data_fetched = 'yes';
				$data = snmpget($this->host_address, $this->community, '.iso.org.dod.internet.mgmt.mib-2.system.sysContact.0', 300);
				if(strlen($data) == 0)
				{
					$data = '<span id="no_data_received">No data received</span>';
				}
			...
			if(snmpget($this->host_address, $this->community, '.iso.org.dod.internet.mgmt.mib-2.system.sysName.0', 300) != FALSE)
			{
				$this->data_fetched = 'yes';
				$data = snmpget($this->host_address, $this->community, '.iso.org.dod.internet.mgmt.mib-2.system.sysName.0', 300);
				if(strlen($data) == 0)
				{
					$data = '<span id="no_data_received">No data received</span>';
				}
			...
			if(snmpget($this->host_address, $this->community, '.iso.org.dod.internet.mgmt.mib-2.system.sysLocation.0', 300) != FALSE)
			{
				$this->data_fetched = 'yes';
				$data = snmpget($this->host_address, $this->community, '.iso.org.dod.internet.mgmt.mib-2.system.sysLocation.0', 300);
				if(strlen($data) == 0)
				{
					$data = '<span id="no_data_received">No data received</span>';
				}
...
//---------- hrSystemDate STARTS HERE
			if(snmpget($this->host_address, $this->community, '.iso.org.dod.internet.mgmt.mib-2.system.sysObjectID.0', 300) != FALSE)
			{
				$this->data_fetched = 'yes';
				$data = snmpget($this->host_address, $this->community, '.iso.org.dod.internet.mgmt.mib-2.system.sysObjectID.0', 300);
				if(strlen($data) == 0)
				{
					$data = '<span id="no_data_received">No data received</span>';
				}
