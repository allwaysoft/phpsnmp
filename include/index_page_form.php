            ...
            print '<div id="index_page_form">';
                print '<form action="information.php" method="POST">';
                    ...
                    print '<div id="block_3" class="block">';
                        print '<div id="sub_block_3">Enter the SNMP Community<br></div>';
                    print '</div>';
                    print '<div id="block_4" class="block">';
                        print '<div id="sub_block_4"><input type="text" name="community" id="community"></div>';
                    print '</div>';
                    print '<div id="block_5" class="block">';
                        print '<div id="sub_block_5"><input type="submit" name="submit" value="search" id="submit_button"></div>';
                    print '</div>';
                print '</form>';
            print '</div>';
        }
